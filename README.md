...
The code and data in this project are in companion with the paper "Detecting embedded surfaces using finite quotients" with Tam Cheetham-West. The code and data will be maintained by Khanh Le at [https://github.com/Khanh-LeCoder](https://github.com/Khanh-LeCoder).
